...
class TelegramNotifier:
    ...
    def send_drawdown_warning(self, drawdown_pct: float, nav: float) -> bool:
    ...
    def send_agent_disagreement(self, ticker: str, reports: dict[str, str]) -> bool:
    ...
    def send_system_health(self, step: str, error: str) -> bool:
